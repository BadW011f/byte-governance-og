    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 68, lineHeight: 1, fontWeight: 900, maxWidth: "1000px" }}>
            {proposal.title}
          </div>
        ...
        <div style={{ display: "flex", gap: "18px", fontSize: 25, fontWeight: 700 }}>
          <div style={{ padding: "16px 20px", borderRadius: 18, background: "rgba(255,255,255,0.08)" }}>
          ...
          <div style={{ padding: "16px 20px", borderRadius: 18, background: "rgba(249,115,22,0.18)", color: "#fdba74" }}>
